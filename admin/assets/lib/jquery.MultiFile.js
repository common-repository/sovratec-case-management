							...
							function (a, b, c) {
								...
								$.each(
									...
									function (i, file) {
										...
										// Disallow duplicates
										$( MultiFile.wrapper ).find( 'input[type=file]' ).not( e ).each(
											function(){
					...
					MultiFile.addToList = function (slave, slave_count, files) {
						...
						$.each(
							...
							function (i, file) {
								...
								label.find( 'img.MultiFile-preview' ).each(
									function(){
										var t        = this;
							...
							b = $( '<a class="MultiFile-remove" href="#' + MultiFile.wrapID + '">' + MultiFile.STRING.remove + '</a>' )
								...
								.click(
									function () {
										...
										$( MultiFile.wrapper ).find( 'input[type=file]' ).each(
											function(){
												// go through each file in each slave
												$.each(
													FILE_LIST( this ),
